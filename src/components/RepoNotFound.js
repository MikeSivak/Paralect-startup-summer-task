...
import '../styles/RepoNotFound.css';
import axios from 'axios';
import PhotoCard from './PhotoCard';

class RepoNotFound extends React.Component {
    ...
    render() {
        return (
            <div>
                ...
                <div className='rnf-group-299'>
                    <div className='rnf-group-icon-search'>
                        <div className='rnf-search-image'>
                    ...
                    <label className='rnf-lbl-instruct'>Repository list is empty</label>
                </div>
            </div>
        );
    }
