...
import '../styles/InitialState.css';

class InitialState extends React.Component {
    render() {
        return (
            <div className='is-group-299'>
                <div className='is-group-icon-search'>
                    <div className='is-search-image'>
                ...
                <label className='is-lbl-instruct'>Start with searching a GitHub user</label>
            </div>
        );
    }
}
